//Filename: prog2.c
//Team Members: SHIVAM GUPTA and SUVANSH KUMAR
//UTD_ID: 2021492803 and 2021426838
//NetID: SXG190040 and SXK170058
//Class: CS5348.001
//Project: OS Project 2
...
int main()
{
	...
	FILE* First_file=fopen("f1.txt","r");
	FILE* Second_file=fopen("f2.txt","r");
	num1_length=0; 
	num2_length=0;
	char ch;
	...
	if(thread_count_no<1 || thread_count_no>50){
			printf("Invalid thread count -- defaulting thread count to 8");
			thread_count_no = 8;
    }
	int flag=0;
	int len=0;
...
// storing the results into the text file
 FILE* Output_file=fopen("c2.txt","w");
